// ffmpeg_screen_audio_pusher.cpp : 定义 DLL 的初始化例程。
//
...
// Cffmpeg_screen_audio_pusherApp 构造
...
// 唯一的一个 Cffmpeg_screen_audio_pusherApp 对象

Cffmpeg_screen_audio_pusherApp theApp;


// Cffmpeg_screen_audio_pusherApp 初始化
